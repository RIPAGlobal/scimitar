...
* You might also wish to look at the RDoc output for `Scimitar::ActiveRecordBackedResourcesController`, or the method description comments from which it is generated inside the `Scimitar::ActiveRecordBackedResourcesController` implementation.
